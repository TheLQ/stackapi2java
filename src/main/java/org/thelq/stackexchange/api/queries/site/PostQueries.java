...
public class PostQueries {
	public <Q extends AbstractComplexFullQuery<PostSort<?>, Q, PostEntry>> Q all() {
		return new AbstractComplexFullQuery<PostSort<?>, Q, PostEntry>(PostEntry.class, new SimpleQueryMethod("posts"))
				.self();
	}
	
	public <Q extends AbstractComplexFullQuery<PostSort<?>, Q, PostEntry>> Q byIds(@NonNull Collection<Integer> postIds) {
		return new AbstractComplexFullQuery<PostSort<?>, Q, PostEntry>(PostEntry.class, new VectorQueryMethod("posts/{}", postIds))
				.self();
	}
	
	public <Q extends AbstractComplexFullQuery<CommentSort<?>, Q, CommentEntry>> Q comments(@NonNull Collection<Integer> postIds) {
	...
	public <Q extends AbstractSiteQuery<Q, CommentEntry>> Q commentAdd(int postId, @NonNull String body) {
		return new AbstractCommentWriteQuery<Q>(CommentEntry.class, new VectorQueryMethod("posts/{}/comments/add", String.valueOf(postId)))
				.setParameter("body", body);
	}
	
	public <Q extends AbstractComplexDateQuery<Q, RevisionEntry>> Q revisions(@NonNull Collection<Integer> postIds) {
		return new AbstractComplexDateQuery<Q, RevisionEntry>(RevisionEntry.class, new VectorQueryMethod("posts/{}/revisions", postIds))
				.self();
	}
	
	public <Q extends AbstractComplexFullQuery<SuggestedEditSort<?>, Q, SuggestedEditEntry>> Q suggestedEdits(@NonNull Collection<Integer> postIds) {
